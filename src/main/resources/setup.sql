...
CALL add_root_ingredient('Altro ingrediente: minerale, fungo, alcol, ...', null);
CALL add_child_ingredient('Altro ingrediente: minerale, fungo, alcol, ...', 'Acqua', null);
CALL add_child_ingredient('Altro ingrediente: minerale, fungo, alcol, ...', 'Sale', null);
CALL add_child_ingredient('Altro ingrediente: minerale, fungo, alcol, ...', 'Fungo', null);
CALL add_child_ingredient('Altro ingrediente: minerale, fungo, alcol, ...', 'Alcol', null);
